!(function(e, t) {
      ...
      for (
        ...
        if (null != (e = arguments[a]))
          for (t in e)
            (n = s[t]),
              s !== (i = e[t]) &&
                (l && i && (T.isPlainObject(i) || (r = T.isArray(i)))
                  ? ((o = r
                      ? ((r = !1), n && T.isArray(n) ? n : [])
                      : n && T.isPlainObject(n)
                      ? n
    ...
    T.extend({
      ...
      map: function(e, t, n) {
        var i,
          ...
          o = e.length,
          s = [];
        if (h(e)) for (; r < o; r++) null != (i = t(e[r], r, n)) && s.push(i);
  ...
  var f = (function(n) {
        ...
        if (p.qsa && (!b || !b.test(e))) {
          if (
            ...
            for (
              ...
              l[u] = d + me(l[u]);
            (h = (J.test(e) && fe(t.parentNode)) || t), (f = l.join(","));
          }
          if (f)
            try {
    ...
    (v = re.setDocument = function(e) {
      ...
      return u !== C && 9 === u.nodeType && u.documentElement
        ? ((r = (C = u).documentElement),
          (n = u.defaultView) &&
            n !== n.top &&
            (n.addEventListener
          ...
          (s = []),
          (b = []),
          (p.qsa = Z.test(u.querySelectorAll)) &&
            (ae(function(e) {
            ...
            ? function(e, t) {
                ...
                return (
                  ...
                  (!p.sortDetached && t.compareDocumentPosition(e) === n)
                    ? e === u || (e.ownerDocument === k && T(k, e))
                      ? -1
                      : t === u || (t.ownerDocument === k && T(k, t))
                      ? 1
                      : l
                      ? O(l, e) - O(l, t)
                      : 0
                ...
                if (c) {
                  if (g) {
                    for (; l; ) {
                      for (o = e; (o = o[l]); )
                        if (
                          y ? o.nodeName.toLowerCase() === d : 1 === o.nodeType
                        )
                          return !1;
                  ...
                  if (((u = [v ? c.firstChild : c.lastChild]), v && h)) {
                    for (
                      a =
                        (i = (r = c[E] || (c[E] = {}))[f] || [])[0] === S &&
                        i[1],
      ...
      return (
        ...
        se(function(e, t, n, i) {
          var r,
            ...
            d = !f || (!e && p) ? c : ye(c, a, f, n, i),
            h = m ? (v || (e ? f : l || g) ? [] : t) : d;
          if ((m && m(d, h, n, i), g))
            for (r = ye(h, u), g(r, [], n, i), o = r.length; o--; )
              (s = r[o]) && (h[u[o]] = !(d[u[o]] = s));
          if (e) {
            if (v || f) {
              if (v) {
          ...
          } else (h = ye(h === t ? h.splice(l, h.length) : h)), v ? v(null, t, h, i) : j.apply(t, h);
        })
      );
    }
    function xe(e) {
      for (
        ...
        if ((t = x.relative[e[a].type])) c = [ge(ve(c), t)];
        else {
    ...
    return (
          ...
          (s = I(
            ...
            (i = function(e, t, n, i, r) {
              ...
              if (((u += l), y && l !== u)) {
                ...
                if (e) {
                  if (0 < u) for (; l--; ) c[l] || d[l] || (d[l] = A.call(i));
                  d = ye(d);
                }
                j.apply(i, d),
                  r &&
      ...
      (g = re.select = function(e, t, n, i) {
          ...
          for (
            ...
            if (
              ...
              (i = u(
                ...
                (J.test(o[0].type) && fe(t.parentNode)) || t
              ))
            ) {
        ...
        return (
          (l || d(e, c))(i, t, !y, n, (J.test(e) && fe(t.parentNode)) || t), n
        );
      }),
      (p.sortStable =
        E.split("")
    ...
    T.fn.extend({
      find: function(e) {
        ...
        if ("string" != typeof e)
          return this.pushStack(
            T(e).filter(function() {
              for (t = 0; t < n; t++) if (T.contains(r[t], this)) return !0;
            })
          );
        for (t = 0; t < n; t++) T.find(e, r[t], i);
        return (
      ...
      is: function(e) {
        return !!C(this, "string" == typeof e && b.test(e) ? T(e) : e || [], !1)
          .length;
      }
    });
  var E,
      ...
      closest: function(e, t) {
        for (
          var n,
            ...
            r = this.length,
            o = [],
            s = b.test(e) || "string" != typeof e ? T(e, t || this.context) : 0;
          i < r;
          i++
        )
      ...
      function(i, r) {
        T.fn[i] = function(e, t) {
          ...
          return (
            ...
            1 < this.length && (I[i] || T.unique(n), S.test(i) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
  ...
  (T.Callbacks = function(r) {
    ...
    var t,
      ...
      d = function(e) {
        for (
          t = r.memory && e, i = !0, u = s || 0, s = 0, a = l.length, o = !0;
          l && u < a;
          u++
        )
          ...
          if (l) {
            ...
            !(function i(e) {
              T.each(e, function(e, t) {
                var n = T.type(t);
                "function" === n
                  ? (r.unique && h.has(t)) || l.push(t)
                  : t && t.length && "string" !== n && i(t);
              });
            })(arguments),
              o ? (a = l.length) : t && ((s = e), d(t));
          }
          return this;
        },
        remove: function() {
  ...
  var q = (T.access = function(e, t, n, i, r, o, s) {
    var a = 0,
      ...
      l = null == n;
    if ("object" === T.type(n))
      for (a in ((r = !0), n)) T.access(e, t, a, n[a], !0, o, s);
    else if (
      void 0 !== i &&
      ((r = !0),
      T.isFunction(i) || (s = !0),
  ...
  (T.acceptData = function(e) {
    ...
    (O.prototype = {
      ...
      set: function(e, t, n) {
        ...
        else if (T.isEmptyObject(o)) T.extend(this.cache[r], t);
  ...
  T.extend({
    ...
    T.fn.extend({
      data: function(i, e) {
            ...
            : q(
                ...
                function(t) {
                  var e,
                    n = T.camelCase(i);
                  if (o && void 0 === t) {
                    if (void 0 !== (e = P.get(o, i))) return e;
                    if (void 0 !== (e = P.get(o, n))) return e;
                    if (void 0 !== (e = F(o, n, void 0))) return e;
                  } else
                    this.each(function() {
                      var e = P.get(this, n);
                      P.set(this, n, t),
        ...
        if (
          this.length &&
          ((r = P.get(o)), 1 === o.nodeType && !z.get(o, "hasDataAttrs"))
        ) {
          for (t = s.length; t--; )
            s[t] &&
              (0 === (n = s[t].name).indexOf("data-") &&
                ((n = T.camelCase(n.slice(5))), F(o, n, r[n])));
  ...
  (T.event = {
          ...
          n.handler && ((n = (o = n).handler), (r = o.selector)),
            ...
            (s = g.handle) ||
              (s = g.handle = function(e) {
                return typeof T !== Y && T.event.triggered !== e.type
        ...
        for (l = (t = (t || "").match(A) || [""]).length; l--; )
          if (
            ...
            s &&
              ...
              delete u[f]);
          } else for (f in u) T.event.remove(e, f + t[l], n, i, !0);
        T.isEmptyObject(u) && (delete g.handle, z.remove(e, "events"));
      }
    },
    trigger: function(e, t, n, i) {
      ...
      if (
        ...
        3 !== n.nodeType &&
          8 !== n.nodeType &&
          !Q.test(h + T.event.triggered) &&
          (0 <= h.indexOf(".") && ((h = (f = h.split(".")).shift()), f.sort()),
          (u = h.indexOf(":") < 0 && "on" + h),
          ((e = e[T.expando]
            ? e
        ...
        if (!i && !c.noBubble && !T.isWindow(n)) {
          for (
            a = c.delegateType || h, Q.test(a + h) || (o = o.parentNode);
            o;
            o = o.parentNode
          )
            d.push(o), (s = o);
          s === (n.ownerDocument || y) &&
            d.push(s.defaultView || s.parentWindow || p);
        }
    ...
    dispatch: function(e) {
      ...
      if (
        ...
        for (
          s = T.event.handlers.call(this, e, u), t = 0;
    ...
    mouseHooks: {
      ...
      filter: function(e, t) {
        ...
        return (
          null == e.pageX &&
            null != t.clientX &&
            ((i = (n = e.target.ownerDocument || y).documentElement),
            (r = n.body),
            (e.pageX =
              t.clientX +
    ...
    if (1 === t.nodeType) {
      if (
        ...
        for (r in (delete s.handle, (s.events = {}), l))
          for (n = 0, i = l[r].length; n < i; n++) T.event.add(t, r, l[r][n]);
      P.hasData(e) && ((a = P.access(e)), (u = T.extend({}, a)), P.set(t, u));
    }
  }
  function pe(e, t) {
  ...
  (ue.optgroup = ue.option),
    ...
    T.extend({
      clone: function(e, t, n) {
        ...
        if (
          ...
          for (s = pe(c), i = 0, r = (o = pe(e)).length; i < r; i++)
            (a = o[i]),
              (u = s[i]),
              void 0,
              "input" === (l = u.nodeName.toLowerCase()) && U.test(a.type)
                ? (u.checked = a.checked)
                : ("input" === l || "textarea" === l) &&
        ...
        return (
          0 < (s = pe(c, "script")).length && he(s, !d && pe(e, "script")), c
        );
      },
          ...
          if ((r = e[h]) || 0 === r)
            if ("object" === T.type(r)) T.merge(d, r.nodeType ? [r] : r);
              ...
              for (
                ...
                o = o.lastChild;
              T.merge(d, o.childNodes), ((o = c.firstChild).textContent = "");
            } else d.push(t.createTextNode(r));
        for (c.textContent = "", h = 0; (r = d[h++]); )
          if (
            (!i || -1 === T.inArray(r, i)) &&
            ((u = T.contains(r.ownerDocument, r)),
            (o = pe(c.appendChild(r), "script")),
            u && he(o),
            n)
          )
            for (l = 0; (r = o[l++]); ) oe.test(r.type || "") && n.push(r);
        return c;
      },
      cleanData: function(e) {
        for (
          var t, n, i, r, o = T.event.special, s = 0;
          void 0 !== (n = e[s]);
          s++
        ) {
    ...
    T.fn.extend({
      ...
      remove: function(e, t) {
        for (
          var n, i = e ? T.filter(e, this) : this, r = 0;
          null != (n = i[r]);
          r++
        )
          t || 1 !== n.nodeType || T.cleanData(pe(n)),
            n.parentNode &&
              (t && T.contains(n.ownerDocument, n) && he(pe(n, "script")),
      ...
      domManip: function(n, i) {
        ...
        if (f || (1 < l && "string" == typeof h && !v.checkClone && re.test(h)))
          return this.each(function(e) {
            var t = c.eq(e);
            f && (n[0] = h.call(this, e, t.html())), t.domManip(n, i);
          });
        if (
          l &&
          ...
          for (o = (r = T.map(pe(e, "script"), ce)).length; u < l; u++)
            (s = e),
              u !== d &&
                ((s = T.clone(s, !0, !0)), o && T.merge(r, pe(s, "script"))),
              i.call(this[u], s, u);
          if (o)
            for (
              a = r[r.length - 1].ownerDocument, T.map(r, de), u = 0;
              u < o;
              u++
            )
              (s = r[u]),
                oe.test(s.type || "") &&
                  ...
                  (s.src
                    ...
                    : T.globalEval(s.textContent.replace(ae, "")));
        }
        return this;
      }
    }),
  ...
  function ve(e, t) {
    var n,
      i = T(t.createElement(e)).appendTo(t.body),
      r =
        p.getDefaultComputedStyle && (n = p.getDefaultComputedStyle(i[0]))
          ? n.display
          : T.css(i[0], "display");
    return i.detach(), r;
  }
  function ye(e) {
    ...
    return (
      n ||
        (("none" !== (n = ve(e, t)) && n) ||
          ((t = (me = (
            me || T("<iframe frameborder='0' width='0' height='0'/>")
  ...
  function Ce(e, t, n) {
    ...
    return (
      ...
      n &&
        ("" !== s || T.contains(e.ownerDocument, e) || (s = T.style(e, t)),
        xe.test(s) &&
          be.test(t) &&
          ((i = a.width),
          (r = a.minWidth),
  ...
  function je(e, t, n, i, r) {
    for (
      ...
      "margin" === n && (s += T.css(e, n + W[o], !0, r)),
        i
          ? ("content" === n && (s -= T.css(e, "padding" + W[o], !0, r)),
            "margin" !== n && (s -= T.css(e, "border" + W[o] + "Width", !0, r)))
          : ((s += T.css(e, "padding" + W[o], !0, r)),
            "padding" !== n &&
              (s += T.css(e, "border" + W[o] + "Width", !0, r)));
    return s;
  }
  function qe(e, t, n) {
    var i = !0,
    ...
    if (r <= 0 || null == r) {
      if (
        (((r = Ce(e, t, o)) < 0 || null == r) && (r = e.style[t]), xe.test(r))
      )
        return r;
  ...
  function Oe(e, t) {
    for (var n, i, r, o = [], s = 0, a = e.length; s < a; s++)
      (i = e[s]).style &&
        ((o[s] = z.get(i, "olddisplay")),
        (n = i.style.display),
        t
          ? (o[s] || "none" !== n || (i.style.display = ""),
            "" === i.style.display &&
              B(i) &&
              (o[s] = z.access(i, "olddisplay", ye(i.nodeName))))
          : ((r = B(i)),
            ("none" === n && r) ||
              z.set(i, "olddisplay", r ? n : T.css(i, "display"))));
    for (s = 0; s < a; s++)
      (i = e[s]).style &&
  ...
  T.extend({
    ...
    style: function(e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var r,
          ...
          u = e.style;
        return (
          (t = T.cssProps[a] || (T.cssProps[a] = Ae(u, a))),
          ...
          void 0 === n
            ...
            : ("string" === (o = typeof n) &&
                (r = Se.exec(n)) &&
                ((n = (r[1] + 1) * r[2] + parseFloat(T.css(e, t))),
                (o = "number")),
              void (
                null != n &&
                n == n &&
    ...
    css: function(e, t, n, i) {
      var r,
        ...
        a = T.camelCase(t);
      return (
        (t = T.cssProps[a] || (T.cssProps[a] = Ae(e.style, a))),
        (s = T.cssHooks[t] || T.cssHooks[a]) &&
          "get" in s &&
          (r = s.get(e, !0, n)),
        void 0 === r && (r = Ce(e, t, i)),
        ...
        "" === n || n
          ? ((o = parseFloat(r)), !0 === n || T.isNumeric(o) ? o || 0 : r)
          : r
      );
    }
  }),
    T.each(["height", "width"], function(e, r) {
      T.cssHooks[r] = {
        get: function(e, t, n) {
          return t
            ? Ee.test(T.css(e, "display")) && 0 === e.offsetWidth
              ? T.swap(e, Ie, function() {
                  return qe(e, r, n);
                })
              : qe(e, r, n)
            : void 0;
        ...
        set: function(e, t, n) {
          ...
          return _e(
            ...
            t,
            n
              ? je(e, r, n, "border-box" === T.css(e, "boxSizing", !1, i), i)
              : 0
          );
        }
      };
    ...
    (T.cssHooks.marginRight = Te(v.reliableMarginRight, function(e, t) {
      return t
        ? T.swap(e, { display: "inline-block" }, Ce, [e, "marginRight"])
        : void 0;
    })),
    ...
    Be = [
      function(t, e, n) {
        ...
        1 === t.nodeType &&
          ...
          (l = T.css(t, "display")),
          "inline" ===
            ("none" === l ? z.get(t, "olddisplay") || ye(t.nodeName) : l) &&
            "none" === T.css(t, "float") &&
        ...
        if (T.isEmptyObject(d))
          ...
          c.done(function() {
            var e;
            for (e in (z.remove(t, "fxshow"), d)) T.style(t, e, d[e]);
          }),
          d))
            (s = Ve(f ? p[i] : 0, i, c)),
              i in p ||
  ...
  function Ve(e, t, n) {
    for (
      var i, r = (Ue[t] || []).concat(Ue["*"]), o = 0, s = r.length;
      o < s;
      o++
    )
  ...
  function Qe(o, e, t) {
    ...
    for (
      ...
      if ((n = Be[i].call(l, o, c, l.opts))) return n;
    return (
      T.map(c, Ve, l),
      T.isFunction(l.opts.start) && l.opts.start.call(o, l),
      T.fx.timer(T.extend(u, { elem: o, anim: l, queue: l.opts.queue })),
      l
  ...
  (T.Animation = T.extend(Qe, {
    tweener: function(e, t) {
      for (
        var n,
          i = 0,
          r = (e = T.isFunction(e) ? ((t = e), ["*"]) : e.split(" ")).length;
        i < r;
        i++
      )
      ...
      stop: function(r, e, o) {
        ...
        return (
          ...
          this.each(function() {
            ...
            else for (t in i) i[t] && i[t].stop && We.test(t) && s(i[t]);
            for (t = n.length; t--; )
              n[t].elem !== this ||
                (null != r && n[t].queue !== r) ||
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute === Y
            ...
            : ((1 === o && T.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (i =
                  T.attrHooks[t] || (T.expr.match.bool.test(t) ? Ge : void 0))),
              void 0 === n
        ...
        : this.each(
            T.isFunction(r)
              ...
              : function() {
                  if ("string" === o)
                    for (
                      var e, t = 0, n = T(this), i = r.match(A) || [];
                      (e = i[t++]);
                    ...
                    (o === Y || "boolean" === o) &&
                      (this.className &&
                        z.set(this, "__className__", this.className),
                      (this.className =
                        this.className || !1 === r
                          ? ""
    ...
    ajax: function(e, t) {
      ...
      if (
        ...
        (m.dataTypes = T.trim(m.dataType || "*")
          ...
          .match(A) || [""]),
        null == m.crossDomain &&
          ((i = ut.exec(m.url.toLowerCase())),
          (m.crossDomain = !(
            !i ||
            (i[1] === ft[1] &&
              i[2] === ft[2] &&
              (i[3] || ("http:" === i[1] ? "80" : "443")) ===
                (ft[3] || ("http:" === ft[1] ? "80" : "443")))
          ))),
        m.data &&
          m.processData &&
      ...
      m.hasContent ||
        (m.data &&
          ((d = m.url += (nt.test(d) ? "&" : "?") + m.data), delete m.data),
        !1 === m.cache &&
          (m.url = rt.test(d)
            ? d.replace(rt, "$1_=" + tt++)
            : d + (nt.test(d) ? "&" : "?") + "_=" + tt++)),
      ...
      if (m.beforeSend && (!1 === m.beforeSend.call(g, C, m) || 2 === w))
        return C.abort();
      for (r in ((a = "abort"), { success: 1, error: 1, complete: 1 }))
        C[r](m[r]);
      if ((c = mt(ct, m, t, C))) {
        (C.readyState = 1),
    ...
    T.each(["get", "post"], function(e, r) {
      T[r] = function(e, t, n, i) {
        return (
          ...
          T.ajax({ url: e, type: r, dataType: i, data: t, success: n })
        );
      };
    }),
  ...
  T.ajaxSetup({
    ...
    T.ajaxPrefilter("json jsonp", function(e, t, n) {
      ...
      return s || "jsonp" === e.dataTypes[0]
        ? ((i = e.jsonpCallback = T.isFunction(e.jsonpCallback)
            ? e.jsonpCallback()
            : e.jsonpCallback),
          s
            ? (e[s] = e[s].replace(Lt, "$1" + i))
            : !1 !== e.jsonp &&
  ...
  (T.fn.load = function(e, t, n) {
    ...
    var i,
      ...
      a = e.indexOf(" ");
    return (
      0 <= a && ((i = T.trim(e.slice(a))), (e = e.slice(0, a))),
      T.isFunction(t)
        ? ((n = t), (t = void 0))
        : t && "object" == typeof t && (r = "POST"),
      0 < s.length &&
        T.ajax({ url: e, type: r, dataType: "html", data: t })
          .done(function(e) {
            (o = arguments),
              s.html(
                i
  ...
  (T.offset = {
          ...
          function(e, t, n) {
            ...
            return void 0 === n
              ? i
                ...
                : e[t]
              : void (i
                  ? i.scrollTo(o ? p.pageXOffset : n, o ? n : p.pageYOffset)
                  : (e[t] = n));
          },
          t,
          e,
    ...
    T.each(["top", "left"], function(e, n) {
      T.cssHooks[n] = Te(v.pixelPosition, function(e, t) {
        return t
          ? ((t = Ce(e, n)), xe.test(t) ? T(e).position()[n] + "px" : t)
          : void 0;
      });
    }),
    T.each({ Height: "height", Width: "width" }, function(o, s) {
      T.each({ padding: "inner" + o, content: s, "": "outer" + o }, function(
        i,
        e
      ) {
        T.fn[e] = function(e, t) {
  ...
  return (
    (T.noConflict = function(e) {
      return p.$ === T && (p.$ = qt), e && p.jQuery === T && (p.jQuery = jt), T;
    }),
    ...
    c.extend(c.fn, {
      ...
      c.extend(c.validator, {
                  ...
                  (n = this.groups[r.name]) &&
                    c.each(this.groups, function(e, t) {
                      t === n &&
                        ...
                        i.name in o.invalid &&
                        (o.currentElements.push(i), (s = s && o.check(i)));
                    }),
                  (t = !1 !== this.check(r)),
                  (s = s && t),
          ...
          defaultMessage: function(e, t) {
            ...
            return (
              "function" == typeof n
                ...
                : i.test(n) &&
                  (n = c.validator.format(n.replace(i, "{$1}"), t.parameters)),
              n
            );
          },
            ...
            s.length
              ...
              : ((n = s = c("<" + this.settings.errorElement + ">")
                ...
                this.labelContainer.length
                  ...
                  ? this.settings.errorPlacement(n, c(e))
                  : n.insertAfter(e),
                s.is("label")
                  ? s.attr("for", a)
                  : 0 ===
        ...
        staticRules: function(e) {
          ...
          return (
            n.settings.rules &&
              (t = c.validator.normalizeRule(n.settings.rules[e.name]) || {}),
            t
          );
        },
        ...
        methods: {
          ...
          remote: function(o, s, e, a) {
            ...
            return (
              ...
              (n = c.param(c.extend({ data: o }, e.data))),
              l.old === n
                ? l.valid
                : ((l.old = n),
        ...
        if (!0 !== this.stop) {
          ...
          a.timeout = setTimeout(function() {
            ...
            if ("^" === t.charAt(0)) {
              var n = 1;
              /^\^\d+/.test(t) &&
                ((n += (t = /\d+/.exec(t)[0]).length), (e = parseInt(t))),
  ...
  (function(e) {
    ...
    var d,
      ...
      x = function(e, t, n, i) {
        ...
        return (
          (r.className = "mfp-" + e),
          n && (r.innerHTML = n),
          i ? t && t.appendChild(r) : ((r = c(r)), t && r.appendTo(t)),
          r
        );
      },
      w = function(e, t) {
        d.ev.triggerHandler("mfp" + e, t),
          d.st.callbacks &&
            ...
            d.st.callbacks[e] &&
              d.st.callbacks[e].apply(d, c.isArray(t) ? t : [t]));
      },
      C = function(e) {
        return (
          (e === t && d.currTemplate.closeBtn) ||
            ((d.currTemplate.closeBtn = c(
      ...
      o = function() {
        c.magnificPopup.instance ||
          ((d = new e()).init(), (c.magnificPopup.instance = d));
      };
    (e.prototype = {
      constructor: e,
      init: function() {
        ...
        if (!d.isOpen) {
          ...
          w("BeforeOpen"),
            ...
            d.fixedContentPos
              ...
              : d.wrap.css({ top: y.scrollTop(), position: "absolute" }),
            (!1 === d.st.fixedBgPos ||
          ...
          return (
            ...
            d.bgOverlay
              .add(d.wrap)
              .prependTo(d.st.prependTo || c(document.body)),
            (d._lastFocusedEl = document.activeElement),
            setTimeout(function() {
              d.content
                ? (d._addClassToMFP(v), d._setFocus())
                : d.bgOverlay.addClass(v),
      ...
      updateItemHTML: function() {
        ...
        var t = e.type;
        if (
          (w("BeforeChange", [d.currItem ? d.currItem.type : "", t]),
          (d.currItem = e),
          !d.currTemplate[t])
        ) {
          var n = !!d.st[t] && d.st[t].markup;
          w("FirstMarkupParse", n), (d.currTemplate[t] = !n || c(n));
        }
        r && r !== e.type && d.container.removeClass("mfp-" + r + "-holder");
        var i = d["get" + t.charAt(0).toUpperCase() + t.slice(1)](
          e,
          d.currTemplate[t]
        );
        d.appendContent(i, t),
      ...
      appendContent: function(e, t) {
        (d.content = e)
          ? d.st.showCloseBtn && d.st.closeBtnInside && !0 === d.currTemplate[t]
            ? d.content.find(".mfp-close").length || d.content.append(C())
            : (d.content = e)
          : (d.content = ""),
          w("BeforeAppend"),
      ...
      (c.fn.magnificPopup = function(e) {
        ...
        if ("string" == typeof e)
          if ("open" === e) {
            ...
            (n = i.items
              ? i.items[r]
              : ((n = t), i.delegate && (n = n.find(i.delegate)), n.eq(r))),
              d._openClick({ mfpEl: n }, t, i);
          } else
        ...
        getInline: function(e, t) {
          if ((I(), e.src)) {
            ...
            if (i.length) {
              ...
              r &&
                r.tagName &&
                (E || ((T = n.hiddenClass), (E = x(T)), (T = "mfp-" + T)),
                (k = i
                  .after(E)
                  .detach()
                  .removeClass(T))),
    ...
    c.magnificPopup.registerModule(N, {
      ...
      proto: {
        ...
        getAjax: function(r) {
          L && c(document.body).addClass(L), d.updateStatus("loading");
          var e = c.extend(
            {
              url: r.src,
              ...
              error: function() {
                A(),
                  ...
                  d.updateStatus(
                    "error",
                    d.st.ajax.tError.replace("%url%", r.src)
                  );
              }
            },
            d.st.ajax.settings
              ...
              ? (j && clearInterval(j),
                e.loadError
                  ? (t.addClass("mfp-loading"),
                    d.updateStatus("error", o.tError.replace("%url%", e.src)))
                  : (t.removeClass("mfp-loading"), d.updateStatus("ready")))
    ...
    c.magnificPopup.registerModule("gallery", {
      ...
      proto: {
        ...
        next: function() {
          (d.direction = !0), (d.index = P(d.index + 1)), d.updateItemHTML();
        },
        prev: function() {
          (d.direction = !1), (d.index = P(d.index - 1)), d.updateItemHTML();
        },
        goTo: function(e) {
  ...
  (function(t, n) {
    ...
    return (
      ...
      (s.makeJQueryPlugin = function(e) {
        (e = e || t.jQuery) &&
          ((i = e).fn.imagesLoaded = function(e, t) {
        ...
        (c.fn[l] = function(e) {
          ...
          return (
            ...
            (t = this).each(function(e, t) {
              ...
              } else h(l + " not initialized. Cannot call methods, i.e. " + u);
            }),
            void 0 !== a ? a : t
          );
        }),
      ...
      if (
        ((function() {
          if (!C) {
            ...
            t.appendChild(e);
            var n = x(e);
            (T.isBoxSizeOuter = w = 200 == v(n.width)), t.removeChild(e);
          }
        })(),
        ...
        for (
          var i = (n.isBorderBox = "border-box" == t.boxSizing), r = 0;
          r < b;
          r++
        ) {
          var o = y[r],
  ...
  (function(e, t) {
    "use strict";
    "function" == typeof define && define.amd
      ? define("matches-selector/matches-selector", t)
      : "object" == typeof module && module.exports
      ? (module.exports = t())
      : (e.matchesSelector = t());
  })(window, function() {
      ...
      (c.htmlInit = function(a, u) {
        c.docReady(function() {
          ...
          i.forEach(function(t) {
            var e,
              n = t.getAttribute(r) || t.getAttribute(o);
            try {
              e = n && JSON.parse(n);
            } catch (e) {
              return void (
                d &&
                d.error("Error parsing " + r + " on " + t.className + ": " + e)
              );
            }
            var i = new a(t, e);
            s && s.data(t, u, i);
  ...
  (function(n, i) {
    ...
    var c =
      "opacity," +
      (a.transform || "transform").replace(/([A-Z])/g, function(e) {
  ...
  (function(e, t) {
    ...
    return (
      ...
      (t.prototype._manageStamp = function(e) {
        ...
        for (
          var a =
              (this._getOption("originTop") ? n.top : n.bottom) + t.outerHeight,
            u = o;
          u <= s;
          u++
        )
  ...
  $(function() {
    ...
    var e = $(window).width(),
      t = $(window).height();
    $(".section.started").css({ height: t - 60 }),
      $(".typed-load").typed({ stringsElement: $(".typing-load"), loop: !0 }),
      $(window).load(function() {
        $(".preloader .pre-inner").fadeOut(800, function() {
          ...
          0 == e.indexOf("#section-") &&
            t.length &&
            $("body, html").animate({ scrollTop: $(e).offset().top - 72 }, 400);
        });
      }),
      $("header .top-menu, .typed-bread").on("click", "a", function() {
        ...
        return (
          0 == e.indexOf("#section-")
            ? ($("body").hasClass("home") || (location.href = "/" + e),
              $("body, html").animate(
                { scrollTop: $(e).offset().top - 110 },
                400
              ),
              $("header").hasClass("active") && $(".menu-btn").trigger("click"))
      ...
      $("header").on("click", ".menu-btn", function() {
        return (
          $("header").hasClass("active")
            ? ($("header").removeClass("active"), $("body").addClass("loaded"))
            : ($("header").addClass("active"), $("body").removeClass("loaded")),
          !1
        );
      }),
      ...
      $(".section").on("click", ".mouse_btn", function() {
        $("body,html").animate({ scrollTop: t - 150 }, 800);
      }),
      $("body").on(
        {
          mouseenter: function() {
    ...
    n_b.imagesLoaded(function() {
      ...
      $(window).resize(function() {
        $(window).width();
        var e = $(window).height();
        $(".section.started").css({ height: e - 60 });
      }),
      e < 840 && $(".section.started").css({ height: t - 30 }),
      $(".section").length &&
        $(".top-menu li a").length &&
